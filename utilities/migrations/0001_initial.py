    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('obj_type', models.ManyToManyField(help_text='The object(s) to which this field applies.', limit_choices_to={'model__in': ('site', 'rack', 'devicetype', 'device', 'aggregate', 'prefix', 'ipaddress', 'vlan', 'vrf', 'provider', 'circuit', 'tenant')}, related_name='custom_fields', to='contenttypes.ContentType', verbose_name='Object(s)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(limit_choices_to={'model__in': ['site', 'rack', 'device', 'consoleport', 'powerport', 'interfaceconnection', 'aggregate', 'prefix', 'ipaddress', 'vlan', 'provider', 'circuit', 'tenant']}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='values', to='utilities.CustomField')),
